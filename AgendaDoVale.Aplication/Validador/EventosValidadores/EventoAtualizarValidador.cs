...
{
    public class EventoAtualizarValidador : AbstractValidator<AtualizarEventoDto>
    {
        public EventoAtualizarValidador()
        {
            RuleFor(x => x.Titulo)
            ...
            RuleFor(x => x.Data)
                ...
                .GreaterThanOrEqualTo(DateOnly.FromDateTime(DateTime.Today)).WithMessage("Data deve ser igual ou posterior a hoje");
